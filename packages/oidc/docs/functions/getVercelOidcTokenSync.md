...
Defined in: [packages/oidc/src/get-vercel-oidc-token.ts:124](https://github.com/marekprusinski/vercel/blob/main/packages/oidc/src/get-vercel-oidc-token.ts#L124)
