...
Defined in: [packages/oidc/src/get-vercel-oidc-token.ts:64](https://github.com/marekprusinski/vercel/blob/main/packages/oidc/src/get-vercel-oidc-token.ts#L64)
